     ...
     return (
          <ImageBackground source={background} className='flex-1'>
               <View className='absolute bottom-12 left-8 flex gap-8'>
                    <GymPro />
                    <Text className='text-white text-4xl leading-9 font-bold'>
                         Alcance seu{'\n'}
                         melhor com{'\n'}
                         praticidade{'\n'}
                         e eficiência
                    ...
                    <TouchableOpacity activeOpacity={0.8} className='py-3 bg-white flex-row items-center justify-center'>
                         <Text className='text-base font-bold mr-3'>Criar conta</Text>
