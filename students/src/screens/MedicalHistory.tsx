import { Text, TouchableOpacity, View, Switch, ScrollView, TextInput } from 'react-native';
               ...
               <ScrollView className='flex-1 bg-white'>
                    <View className='mt-20 mb-8 px-8'>
                         ...
                         <View className='mt-4 space-y-3'>
                              ...
                              <View className='flex-col justify-between pb-4 border-b-[1px] border-b-gray-100'>
                                   ...
                                   <View className='mt-4 flex-row justify-between space-x-4'>
                                        <TouchableOpacity
                                             activeOpacity={0.7}
                                             onPress={() => setLifeStyle(previousState => !previousState)}
                         ...
                         <TouchableOpacity
                              ...
                              className={`my-8 p-3 space-x-3 flex-row items-center rounded-lg border-[1px] ${responsibilityTerm ? 'border-green-300' : 'border-red-300'}`}
                         >
