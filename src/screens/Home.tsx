     ...
     return (
          <ScrollView>
               ...
               <View className='py-8 px-8'>
                    ...
                    <View className='mt-8 bg-gray-300 rounded flex-row justify-between items-center px-5 py-5'>
                    ...
                    <TouchableOpacity activeOpacity={0.7} className='mt-8 bg-gray-300 rounded flex-row justify-between items-center px-5 py-5'>
                    ...
                    <TouchableOpacity activeOpacity={0.7} className='mt-5 bg-gray-300 rounded flex-row justify-between items-center px-5 py-5'>
                         <View className='flex-row gap-3 items-center'>
                              <Octicons name="dot-fill" size={24} color="black" />
                              <Text className='font-title text-base mb-1'>
                                   Tríceps e costa
                    ...
                    <View className='flex-row space-x-4 mt-8'>
                         <View className='p-5 bg-gray-300 rounded flex-1 items-center justify-center gap-1'>
